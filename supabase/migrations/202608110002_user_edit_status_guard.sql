-- Impide editar datos administrativos de perfiles Inactivos o Suspendidos.
-- Incremental posterior a 202608110001; no modifica relaciones UCU/UEV.
...
begin
  ...
  if v_target.usr_estado not in ('Activo','Preregistrado') then
    raise exception using errcode='P0001',message='USER_EDIT_INVALID_STATUS';
  end if;

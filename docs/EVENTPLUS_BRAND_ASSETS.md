...
Según la documentación de Flet, `assets_dir` define la carpeta donde se almacenan los archivos locales, y las rutas usadas por controles como `ft.Image` deben ser relativas a esa carpeta.
...
## 8. Reglas para modo claro y modo oscuro
...
## 10. Instrucción obligatoria para Codex
...
Cuando cree la pantalla de login o el App Shell, debe usar uno de los logos oficiales desde `assets/brand/`.
